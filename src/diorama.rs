...
pub fn create_diorama() -> Vec<Box<dyn RayIntersect>> {
    ...
    let  redstone_lamp = Rc::new(Material::new(
       ...
       let cube_data = [
            ...
            (Vec3::new(-1.0, 2.1, -5.0), Rc::clone(&redstone_lamp)),
            (Vec3::new(-1.0, 2.5, -5.0), Rc::clone(&redstone_lamp)),
            (Vec3::new(-1.0, 2.9, -5.0), Rc::clone(&redstone_lamp)),
            ...
            (Vec3::new(-2.6, 2.9, -5.0), Rc::clone(&redstone_lamp)),
            (Vec3::new(-2.2, 2.9, -5.0), Rc::clone(&redstone_lamp)),
            (Vec3::new(-1.8, 2.9, -5.0), Rc::clone(&redstone_lamp)),
